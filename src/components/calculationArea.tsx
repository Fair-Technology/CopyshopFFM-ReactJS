    ...
    <table className="min-w-full bg-white border border-gray-200">
      <tbody>
        ...
        <tr>
          ...
          <td className="py-2 px-4 border-b border-l border-gray-200">80g/m<sup>2</sup></td>
        </tr>
        <tr>
 ...
 const CostSum =()=>{
  return <div>
    ...
    <div className="min-w-full">
      ...
      <div className="bg-orange-500 text-sm px-1">* If you pick at store, the delivery fee will be 0</div>
    </div>
  </div>
 }