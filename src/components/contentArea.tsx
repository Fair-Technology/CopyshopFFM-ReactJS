	...
	return (
		<div>
			...
			<select
				id="format"
				defaultValue="A4"
				className="w-full border h-10 pl-1 rounded focus:outline-none focus:ring-0"
			>
	...
	return (
		<div className="flex items-center gap-4 ">
			...
			<input
				...
				min="1"
				defaultValue="1"
				className="flex-1  border p-2 rounded focus:outline-none focus:ring-0"
			/>
		...
		<div className="flex flex-col md:flex-row">
			...
			<div className="flex-1 flex justify-center gap-4 md:ml-4">
				<div className="flex-1 flex flex-col items-center  gap-4">
					<Product
						title="softcover"
						isSelected={selected === "softcover"}
					></Product>
					<Product
						title="holePunch"
						isSelected={selected === "holePunch"}
					></Product>
				</div>
				<div className="flex-1 flex flex-col items-center  gap-4">
					<Product
						title="hardcover"
						isSelected={selected === "hardcover"}
					></Product>
					<Product
						title="lamination"
						isSelected={selected === "lamination"}
					></Product>
				</div>
			</div>
		</div>
...
const Product = ({
	...
	return (
		<div
			className={cn(
				"flex flex-col items-center bg-slate-50 rounded-lg w-36 py-2 border ",
				isSelected ? "bg-slate-50" : "bg-slate-50"
			)}
		>
			...
			<div className="text-center text-sm font-bold text-slate-700 py-2">
				{title}
			</div>
